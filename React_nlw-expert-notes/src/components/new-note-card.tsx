          ...
          <form className='flex flex-col flex-1'>
            ...
            {isRecording ? (
              <button
                ...
                className='w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300  font-medium hover:text-slate-100 focus-visible:ring-2 focus-visible:ring-slate-800 focus-visible:bg-lime-500 outline-none'
              >
